...
public class Albums extends AppCompatActivity implements Response.Listener<JSONArray>,
        Response.ErrorListener {

    List<com.example.login.model.Post> albums =  new ArrayList<>();
    ...
    public void onResponse(JSONArray response) {
        try {
            ...
            for(com.example.login.model.Post obj1 : albums) {
